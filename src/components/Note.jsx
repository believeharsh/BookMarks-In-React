...
const Note = ({id, handleDeleteNote, OpenMenu, handleOpenMenu}) => {
	...
	return (
		...
		<div className="bg-tranparent  hover:border-[1px] mx-1 my-1 px-3 py-2 rounded-xl w-[70px] h-[70px] hover:bg-gray-400 hover:border-black hover:text-white  hover:font-thin relative">
	        ...
	        <a href={id.url} className='text-sm' target='_blank'>
		
				<img src={"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=" + id.url + "&size=24"}alt="" />
				<span>{id.name}</span>
			</a>
			<div className="">
